...
SWFFONT* swf_LoadTrueTypeFont(const char*filename, char flashtype)
{
    ...
    font = (SWFFONT*)calloc(1, sizeof(SWFFONT));
    font->id = -1;
    font->version = flashtype?3:2;

    font->layout = (SWFLAYOUT*)calloc(1, sizeof(SWFLAYOUT));
    font->layout->bounds = (SRECT*)calloc(1, face->num_glyphs*sizeof(SRECT));
    ...
    font->glyph2ascii = (U16*)calloc(1, face->num_glyphs*sizeof(U16));
    font->maxascii = 0;
    font->glyph = (SWFGLYPH*)calloc(1, face->num_glyphs*sizeof(SWFGLYPH));
    if(FT_HAS_GLYPH_NAMES(face)) {
        font->glyphnames = (char**)calloc(1, face->num_glyphs*sizeof(char*));
    }
    ...
    font->ascii2glyph = (int*)calloc(1, font->maxascii*sizeof(int));
    ...
    glyph2glyph = (int*)calloc(1, face->num_glyphs*sizeof(int));
...
SWFFONT* swf_LoadT1Font(const char*filename)
{
    ...
    font->glyph = (SWFGLYPH*)calloc(1, num*sizeof(SWFGLYPH));
    font->glyph2ascii = (U16*)calloc(1, num*sizeof(U16));
    font->ascii2glyph = (int*)calloc(1, font->maxascii*sizeof(int));
    ...
    font->layout->leading = (U16)(font->layout->ascent -
                                  font->layout->descent -
                                  (bbox.lly - bbox.ury));
    font->layout->bounds = (SRECT*)calloc(1, sizeof(SRECT)*num);
    font->layout->kerningcount = 0;
    font->layout->kerning = 0;
    font->glyphnames = calloc(1, num*sizeof(char*));
...
{
    SWFFONT*font = (SWFFONT*)calloc(1, sizeof(SWFFONT));
    return font;
}
