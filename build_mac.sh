...
-framework Foundation -framework AVFoundation -framework CoreAudio -framework CoreVideo -framework CoreMedia -framework CoreGraphics -framework VideoToolbox \
-framework OpenGL -framework AudioToolbox -framework IOKit -framework AppKit -framework ForceFeedback
