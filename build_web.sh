...
emcc -O3 nanovg/nanovg.c svg.c svgb.c swf.c lunzip.c swftools/lib/*.c swftools/lib/modules/*.c swftools/lib/action/*.c -I. -Inanovg -Iswftools/lib -o lvg_player.html -s USE_GLFW=3 -s TOTAL_MEMORY=128000000 -s MAIN_MODULE=1
