...
emcc -O3 nanovg/nanovg.c adpcm.c lvg_audio.c svg.c svgb.c swf.c lunzip.c swftools/lib/*.c swftools/lib/modules/*.c swftools/lib/action/*.c mp3/minimp3.c -I. -Inanovg -Iswftools/lib -Imp3 -DNDEBUG -o lvg_player.html -s USE_GLFW=3 -s USE_SDL=2 -s FULL_ES3=1 -s TOTAL_MEMORY=268435456 -s MAIN_MODULE=1
