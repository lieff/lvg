...
emcc -O3 nanovg/nanovg.c lvg_audio.c lvg.c svgb.c lunzip.c \
...
-I. -Iscripting/tcc -Inanovg -Iswf/swftools/lib -Imp3 -DNDEBUG -o lvg_player.html -s USE_GLFW=3 -s USE_SDL=2 -s FULL_ES3=1 -s TOTAL_MEMORY=268435456 -s MAIN_MODULE=1
