...
emcc -Os nanovg.c svg.c zip/*.c zlib/*.c -I. -Izlib -Izip -DHAVE_CONFIG_H -o index.html --preload-file test.lvg -s USE_GLFW=3 -s TOTAL_MEMORY=128000000 -s MAIN_MODULE=1
