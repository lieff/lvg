gcc -s -Os -flto -std=gnu99 -Wall -fno-asynchronous-unwind-tables -fno-stack-protector nanovg/nanovg.c adpcm.c lvg_audio.c lvg.c svgb.c swf.c lunzip.c \
...
objcopy --remove-section=.comment --remove-section=.note* --remove-section=.eh_frame* --remove-section=.jcr ./lvg
